...
configuration. It is also `aisecscan`'s canonical **known-good fixture**: it must
scan with zero findings, and every hardening choice maps 1:1 to a `aisecscan` check.
